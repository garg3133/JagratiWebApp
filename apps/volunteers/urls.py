...
urlpatterns = [
    ...
    path('ajax/update_schedule/',
         views.ajax_update_schedule,
         name='ajax_update_schedule'),

    # Needs to be changed
    # Not needed, update in profile/ only
    path('profile/update/', views.update_profile, name='update_profile'),
    path('list/', views.volunteers_list, name='volunteers_list'),
    path('ajax/list/', views.ajax_volunteers_list,
         name='ajax_volunteers_list'),
]
