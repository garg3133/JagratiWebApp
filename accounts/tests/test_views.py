...
class LoginSignupViewTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user1 = User.objects.create_user(
            email='testuser1@gmail.com', password='1X<ISRUkw+tuK')
        ...
        test_user2 = User.objects.create_user(
            email='testuser2@gmail.com', password='2HJ1vRV0Z&3iD')
    ...
    def test_view_login_with_incorrect_username(self):
        ...
        self.assertTemplateUsed(response, 'accounts/login_signup.html')
        self.assertEqual(
            response.context['login_error'], 'Invalid credentials')
    ...
    def test_view_signup_with_valid_data(self):
        ...
        self.assertTemplateUsed(
            response, 'accounts/email/account_activation_email.html')
    ...
    def test_view_signup_with_existing_user(self):
        ...
        self.assertTemplateUsed(response, 'accounts/login_signup.html')
        self.assertEqual(
            response.context['signup_error'], 'Account with entered email already exists')
