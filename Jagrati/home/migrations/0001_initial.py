    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_email', models.EmailField(max_length=255, verbose_name='Alternate Email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.Calendar')),
                ('sid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.Student', verbose_name='Student Name')),
            ],
            options={
